...
(function() {
  $(function() {
    ...
    $('#element_is_finished').change(function() {
      if (this.checked) {
        $('.element_finished_hidden').show();
      } else {
        $('.element_finished_hidden').hide();
      }
    });
    $('.elements').children('.listitem').click(function() {
      $('.elements').children('.listitem').removeClass('selected');
      $(this).addClass('selected');
      window.element_id = $(this).attr("element_id");
      $('.subelement_lust').html("Loading...");
      return $.ajax('/project_elements/' + window.element_id + '/subelements', {
        dataType: 'html'
      }).done(function(data, status, jqXHR) {
        return $('.subelement_list').html(data);
      });
    });
    $('.add_element').click(function() {
      return $('#element_dialog').show();
    });
    return $('#new_project_element').submit(function(e) {
      var obj, postData, url;
      e.preventDefault();
      postData = $('#new_project_element').serializeArray();
      postData.push({
        name: 'project_element[project_id]',
      ...
      obj.done(function(data, status, jqXHR) {
        if (data === "success") {
          $('#element_dialog').hide();
          return $.ajax('/projects/' + $("#project_id").val() + '/elements.ajax').done(function(data, status, jqXHR) {
            $('.element_container').html(data);
            $('.add_element').click(function() {
              return $('#element_dialog').show();
            });
            $('.add_subelement').click(function() {
              return $('#subelement_dialog').show();
            });
            return $('.elements').children('.listitem').click(function() {
              $('.elements').children('.listitem').removeClass('selected');
              $(this).addClass('selected');
              window.element_id = $(this).attr("element_id");
              $('.subelement_lust').html("Loading...");
          ...
          return $('#element_dialog').html(data);
        }
      });
      return false;
    });
...
(function() {
  $(function() {
    $('#subelement_is_finished').change(function() {
      if (this.checked) {
        $('.subelement_finished_hidden').show();
      } else {
        $('.subelement_finished_hidden').hide();
      }
    });
    $('.add_subelement').click(function() {
      return $('#subelement_dialog').show();
    });
    return $('#new_project_subelement').submit(function(e) {
      var obj, postData, url;
      e.preventDefault();
      postData = $('#new_project_subelement').serializeArray();
      postData.push({
        name: 'project_subelement[project_element_id]',
        value: window.element_id
      });
      ...
      obj.done(function(data, status, jqXHR) {
        if (data === "success") {
          ...
          return $.ajax('/project_elements/' + window.element_id + '/subelements.ajax').done(function(data, status, jqXHR) {
            return $('.subelement_list').html(data);
          });
        } else {
          return $('#subelement_dialog').html(data);
        }
      });
    });
  });
...
(function() {
  $(function() {
    return $("#project_is_finished").change(function() {
      if (this.checked) {
        $(".project_finished_hidden").show();
      } else {
        $(".project_finished_hidden").hide();
      }
    });
  });
